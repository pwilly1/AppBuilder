...
- Button supports no action, page navigation, repeatable hosted-data submission, signed-in-user save/delete, generated-app signup/login/logout, safe external URLs, or page-variable updates through the shared block-action contract
