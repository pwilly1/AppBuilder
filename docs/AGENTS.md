...
- Button may update or delete the signed-in app user's newest owned collection record. Keep field mapping, own-record access validation, delete confirmation, and post-mutation binding refresh aligned across web and Android.
