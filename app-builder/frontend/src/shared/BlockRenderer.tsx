...
export function BlockRenderer({
  ...
  return Cmp ? <Cmp {...resolvedProps} appearance={resolvedProps} typography={resolvedProps} action={action} blockId={block.id} projectId={projectId} previewMode={previewMode} contentScale={contentScale} runtimeContext={runtimeContext} onNavigate={onNavigate} onSetPageState={onSetPageState}>{children}</Cmp> : null;
}
